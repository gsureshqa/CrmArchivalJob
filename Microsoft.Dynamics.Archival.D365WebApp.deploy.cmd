...
set _DeploySetParametersFile=%RootPath%Microsoft.Dynamics.Archival.D365WebApp.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Microsoft.Dynamics.Archival.D365WebApp.zip" (
echo "%RootPath%Microsoft.Dynamics.Archival.D365WebApp.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Microsoft.Dynamics.Archival.D365WebApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Microsoft.Dynamics.Archival.D365WebApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Microsoft.Dynamics.Archival.D365WebApp.deploy-readme.txt" (
...
start notepad "%RootPath%Microsoft.Dynamics.Archival.D365WebApp.deploy-readme.txt"
)
echo =========================================================
goto :eof
